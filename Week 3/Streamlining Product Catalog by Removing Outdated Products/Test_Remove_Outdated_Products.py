...
class TestDiscontinuedProducts(unittest.TestCase):
    ...
    def test_case_9(self):
        catalog = list(range(1000, 2000)) + [1500] * 1000
        result = Discontinued_Products(catalog, 1500)
        self.assertEqual(result, 1000)
        self.assertEqual(catalog[:1000], list(range(1000, 2000)))
        self.assertEqual(catalog[1000:], [None] * 1000)
